...
![spark-repl](https://github.com/mbonaci/spark/resources/spark-repl.png)
...
![master's web console](https://github.com/mbonaci/spark/resources/spark-web-console.gif)
...
![4 slaves start](https://github.com/mbonaci/spark/resources/spark-4-slaves-started.png)

If you now refresh master's web console, you should see 4 slaves listed there:

![4 slaves in web console](https://github.com/mbonaci/spark/resources/spark-master-web-console-4-slaves.gif)

Clicking on a slave's link opens its web console:

![slave web console](https://github.com/mbonaci/spark/resources/spark-slaves-web-console.gif)
